...
/usr/bin/sqoop export --connect jdbc:mysql://10.1.16.60:3306/CPlog --username obd_message --password obd_message --table i_cp_req_cnt --hcatalog-database cp_project --hcatalog-table i_cp_req_cnt --hcatalog-partition-keys date --hcatalog-partition-values $day_01
